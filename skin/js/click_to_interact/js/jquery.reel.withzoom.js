         ...
         var
          ...
          setup: function(e)
          {
            ...
            if(opt.balastop==1000)
            {
             ...
             $('#zoom').html('<img id="buttons_view_enlarged1" class="product_rotate_buttons product_rotate_horizontal_interact_buttons" width="4%" href="javascript:void(0)" src="'+SKIN_URL+'/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons product_rotate_horizontal_interact_buttons buttons_view_enlarged"width="4%" href="javascript:void(0)"  src="'+SKIN_URL+'/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons product_rotate_autoplay_buttons buttons_view_enlarged" width="4%" href="javascript:void(0)"  src="'+SKIN_URL+'/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons product_rotate_autoplay_buttons buttons_view_enlarged" width="4%" href="javascript:void(0)" src="'+SKIN_URL+'/p.png" id="product_rotate_pause"><img class="product_rotate_buttons product_rotate_autoplay_buttons " width="4%" href="javascript:void(0)"  src="'+SKIN_URL+'/a.png" id="product_rotate_rotate">');              
            }
            else
            {
                //with zoom buttom
             $('#zoom').html('<img class="product_rotate_buttons buttons_view_minimised product_rotate_zoom_buttons" width="4%" padding="0px" href="javascript:void(0)" src="'+SKIN_URL+'/plus.png" id="product_rotate_zoomin"><img class="product_rotate_buttons buttons_view_minimised product_rotate_zoom_buttons" width="4%" padding="0px" href="javascript:void(0)" src="'+SKIN_URL+'/minus.png" id="product_rotate_zoomout"><img class="product_rotate_buttons buttons_view_minimised product_rotate_horizontal_interact_buttons" width="4%" padding="0px" href="javascript:void(0)" src="'+SKIN_URL+'/l.png" id="product_rotate_leftframe"><img class="product_rotate_buttons buttons_view_minimised product_rotate_horizontal_interact_buttons" width="4%" padding="0px" href="javascript:void(0)" src="'+SKIN_URL+'/r.png" id="product_rotate_rightframe"><img class="product_rotate_buttons buttons_view_minimised product_rotate_autoplay_buttons" width="4%" padding="0px" href="javascript:void(0)" src="'+SKIN_URL+'/c.png" id="product_rotate_antirotate"><img class="product_rotate_buttons buttons_view_minimised product_rotate_autoplay_buttons" width="4%" padding="0px" href="javascript:void(0)" src="'+SKIN_URL+'/p.png" id="product_rotate_pause"><img class="product_rotate_buttons buttons_view_minimised product_rotate_autoplay_buttons" width="4%" padding="0px" href="javascript:void(0)" src="'+SKIN_URL+'/a.png" id="product_rotate_rotate">');               
            }
            //function created by CG
